...
<table style="width:100%;">
  <tr>
    <td style="vertical-align: top; padding: 10px;">
      <div style="border: 6px solid #4CAF50; border-radius: 8px; padding: 20px; box-shadow: 2px 2px 8px rgba(0,0,0,0.3);">
### 🖥️ サーバー起動処理
...
<table style="width:100%;">
  <tr>
    <td style="vertical-align: top; padding: 10px;">
      <div style="border: 6px solid #FF9800; border-radius: 8px; padding: 20px; box-shadow: 2px 2px 8px rgba(0,0,0,0.3);">
